// Public API de inventario-ui
// Importá estos componentes en cualquier micro-frontend para tener
// la misma estructura visual: layout, barra lateral, barra superior,
